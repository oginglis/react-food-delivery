  ...
  render() {
    return (
      <div>
        ...
        <Nav burgerActive={this.state.burgerActive} changePopoutState={this.changePopoutState} handleShopClick={this.handleShopClick} toggleModalActive={this.toggleModalActive} />
        ...
        <InfoBanner id="samples" bannerButton="ORDER HERE" bannerTitle="test us out with free samples" bgImage="https://images.unsplash.com/photo-1583369105080-4337ce9e917d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2734&q=80" />
        ...
        <SearchBanner toggleModalActive={this.toggleModalActive} bgImage="https://images.unsplash.com/photo-1497935586351-b67a49e012bf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2251&q=80" />
        <Modal modalActive={this.state.modalActive} toggleModalActive={this.toggleModalActive}/>
        <Footer toggleModalActive={this.toggleModalActive}/>
      </div>
    )
  }
}
